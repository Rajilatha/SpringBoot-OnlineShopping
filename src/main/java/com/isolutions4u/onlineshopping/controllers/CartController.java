...
public class CartController {
	...
	public ModelAndView showCart(@RequestParam(name = "result", required = false) String result) {
		...
		if (result != null) {
			switch (result) {
			case "updated":
				modelAndView.addObject("message", "Quantity has been updated sucessfully");
				break;
			...
			case "added":
				modelAndView.addObject("message", "Product has been added sucessfully!");
				break;

			case "deleted":
				modelAndView.addObject("message", "Product has been removed sucessfully");
				break;
			default:
				break;
			}
